...
inline void Runtime::renderElement(
    ...
    if (element.kind == ElementKind::Rect) {
        ...
        runtime::CanvasInstance& canvasInst = canvasInstance(element.id);
        Rect visual = toPixelRect(transformRect({canvasInst.frame.value().x,
                                                 canvasInst.frame.value().y,
                                                 canvasInst.frame.value().width,
